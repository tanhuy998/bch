...
func (this *mongo_filter[Model_T]) Find(ctx context.Context) ([]*Model_T, error) {

	return findManyDocuments[Model_T](this.filter, &this.MongoDBQueryMonitorCollection, ctx)
}

func (this *mongo_filter[Model_T]) FindOne(ctx context.Context) (*Model_T, error) {

	return findOneDocument[Model_T](this.filter, &this.MongoDBQueryMonitorCollection, ctx)
}

func (this *mongo_filter[Model_T]) Update(updateEntity Model_T, ctx context.Context) error {

	return this.UpdateManyByFilter(this.filter, updateEntity, ctx)
}
