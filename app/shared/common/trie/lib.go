...
// func NewTrieNode[T comparable]() trie_node_t[T] {

// 	return newTrieNode(nil)
// }

// func newTrieNode[T comparable](ref *trie_node_t[T]) (ret trie_node_t[T]) {

// 	ret = trie_node_t[T]{}
// 	ret.cur = make(map[string]*trie_node_t[T])
...
// func merge[T comparable](path string, ref *trie_node_t[T]) *trie_node_t[T] {
...
// 			currentNode.cur = make(map[string]*trie_node_t[T])
// 		}
...
// func ret_match_enpoint[T comparable](path string, ref *trie_node_t[T]) (ret trie_node_t[T], err error) {
