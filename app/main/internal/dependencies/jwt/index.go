...
// 	fmt.Println("Reading auth key pair", jwt_asym_private_key, jwt_asym_public_key)
...
// 	buffer, err = os.ReadFile(path.Join(__dir, os.Getenv(bootstrap.ENV_AUTH_JWT_PRIVATE_KEY_DIR)))
...
// 	buffer, err = os.ReadFile(path.Join(__dir, os.Getenv(bootstrap.ENV_AUTH_JWT_PUBLIC_KEY_DIR)))
...
// 	sym_secret_str := os.Getenv(bootstrap.ENV_APP_SECRET)
