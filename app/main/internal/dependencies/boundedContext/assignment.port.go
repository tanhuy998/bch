...
func RegisterAssignmentBoundedContext(container *hero.Container) {
	...
	irisIoc.BindDependency[assignmentServicePort.IGetAssignments[model.Assignment], getAssignmentsDomain.GetAssignmentsService](container, nil)
	irisIoc.BindDependency[assignmentServicePort.IGetAssignmentGroups[interface{}, model.AssignmentGroup], getAssignmentGroupsDomain.GetAssignmentGroupsService](container, nil)
	...
	irisIoc.BindDependency[
		usecasePort.IUseCase[requestPresenter.GetAssignments, responsePresenter.GetAssignments[model.Assignment]],
